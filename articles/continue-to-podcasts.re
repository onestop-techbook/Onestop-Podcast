...
なんといっても、Podcastの最大の障壁は継続することです。始めることは簡単でも、リスナーがいるのかいるのか実感できずフィードバックがない、ネタ切れする、ゲストが見つからない、など、さまざまな障壁があります。
...
//image[aozorafm_guest_01][Twitterでのゲスト募集]
...
//image[agenda_01][アジェンダに悩んでいたときのyyyknへの空中リプライ]
...
当初は、技術書典5の本を紹介をするといったコンセプトで始めたおやかたaｍですが、パーソナリティの都合が合わず、なかなか収録ができない状態が続いていました。
...
例えば、技術書典のようなイベントが発生した時に「ちょっとポッドキャストでも撮ってみるか」思えるくらいのペースでも構わないと思います
...
「自分で話すネタを考えるのは大変そうだし、きっと続かないだろうなぁ。ニュースの紹介ならネタ切れになることはないし、自分にも続けられるんじゃ！？」そう思って始めたニュース系のポッドキャストも、実は以外に手間がかかったりします。
...
しかし、その評価を貰えるとことすら出来ない状況、それが再生数0です。
...
Podcast自体も楽しいのですが、関連するイベントなど、Podcastに関連したイベント、楽しみもあります。本節では、そういったイベントなどについて取り上げます。
