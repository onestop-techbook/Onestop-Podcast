...
//embed{
    ...
    \hspace{1ex}
//}
「技術書を生やすお兄さん」として、技術書執筆者のみなさんと楽しくやってます。技術書執筆のメリットとメソッドを布教中。執筆は、「アウトプットの一つの形」としておススメ。コミケと技術書典、その他技術同人誌に関連するイベントにはできるだけ参加したいと思ってます。イベント会場でぼくと握手。

普段は「レーザープロジェクタを自作するためのいろいろ」というあたりのネタで執筆中。デッドライナーだけど、最近締め切りをでっち上げて自分の尻を叩く方法を学んだので、コンスタントに本が書けるようになった。プログラミングは苦手。合同誌のネタはいつでも募集中です。思いついたことがあれば教えてください。お膳立てとお手伝いします！
